...
function clearList(listId) {
  ...
  emptyDiv.textContent = chrome.i18n.getMessage('no_items_yet') || 'No items yet';
  list.innerHTML = '';
...
async function onLangChange(newLang) {
  await window.i18n.setLang(newLang); // setLang now reloads popup
}
...
async function init() {
  try {
    ...
    console.log("Lang:", lang, "Messages sample:", chrome.i18n.getMessage("app_title"));
