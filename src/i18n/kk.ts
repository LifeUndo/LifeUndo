export default {
  ...
  howItWorks: {
    title: "How it works",
    step1Title: "Install",
    step1Description: "Download extension for Chrome, Firefox or Edge. One click — protection is active.",
    step2Title: "Keep working",
    step2Description: "Fill forms, copy text, open tabs. Everything saves locally in your browser.",
    step3Title: "Restore when needed",
    step3Description: "Accidentally closed a tab? Lost text? Press \"Undo\" — everything is back in place."
  },
  cta: {
    ready: "Ready to try?",
