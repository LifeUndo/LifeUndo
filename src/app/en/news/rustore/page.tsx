export default function RuStorePageEN() {
  return (
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold text-white mb-6">
            GetLifeUndo in RuStore
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Mobile version of GetLifeUndo coming to Russian app store
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-16">
          <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-8">
            ...
            <p className="text-gray-300 mb-6 text-center">
              Leave your email and we'll notify when the app appears in RuStore
            </p>
