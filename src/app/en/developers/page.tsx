  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-6">
            <h2 className="text-2xl font-semibold text-white mb-6">Endpoints (draft, REST)</h2>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-6">
            <h2 className="text-2xl font-semibold text-white mb-6">Authentication & Limits</h2>
            <div className="space-y-4 text-gray-300">
              <p><strong>Authentication:</strong> Authorization: Bearer &lt;api_key&gt;</p>
              <p><strong>Rate limit:</strong> 60 req/min/IP (default)</p>
              <p><strong>Status:</strong> Closed beta. Get keys: support@getlifeundo.com or t.me/GetLifeUndoSupport</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-6">
            <h2 className="text-2xl font-semibold text-white mb-6">Example (cURL)</h2>
            <div className="bg-black/20 rounded-lg p-4">
