    ...
    <div className="space-y-6 text-xs">
      <div className="space-y-2">
        ...
        <p className="text-slate-400 max-w-2xl">
          Внутренний web-клиент устройства прямо внутри админ-панели. Использует тот же
          backend, что и расширение: лицензии, пейринг, короткие коды. Можно застейджить и
          отладить Mesh без нативного клиента.
        </p>
        <p className="text-slate-400 max-w-2xl">
          Для админских API используется заголовок <code>X-Admin-Token</code>, который
          вводится один раз на странице входа <code>/admin/login</code> и сохраняется в
          браузере. Этот web-клиент устройств ходит по своим Mesh-эндпоинтам и не требует
      ...
      <section className="rounded-xl border border-slate-800 bg-slate-900/60 p-4 space-y-3 text-xs">
        ...
        <div className="mt-3 text-[11px] text-slate-500 leading-snug">
          <p>
            Сценарий: на ПЕРВОМ устройстве (например, этот web-клиент или расширение)
            нажмите «Создать код» / «Показать код» и передайте короткий код.
          </p>
          <p className="mt-1">
            На ВТОРОМ устройстве откройте раздел «Ваши устройства» или эту страницу Ops-консоли,
            введите код в поле «Подтвердить код» и нажмите кнопку. Код действует примерно 15
            минут и <span className="font-semibold">используется один раз</span>. После
            успешной связки он перестаёт работать.
          </p>
          <p className="mt-1">
            Например: на ПК откройте эту Ops-консоль или отдельную страницу `/device`,
            нажмите «Создать код», а на телефоне в расширении откройте «Ваши устройства» и
            введите этот код в поле «Подтвердить код».
          </p>
        </div>
      </section>
