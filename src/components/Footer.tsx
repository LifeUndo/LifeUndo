    ...
    <footer className="mt-16 border-t border-gray-800 bg-[#0B1220]">
      <div className="mx-auto max-w-5xl p-6 text-center">
        <div className="mb-4 flex items-center justify-center gap-4">
          <img 
            src="/brand/getlifeundo-logo.svg" 
            alt={USE_NEW_FEATURES ? "GetLifeUndo" : "LifeUndo"} 
            className="h-8 w-8"
          />
        ...
        {/* FreeKassa баннер убран из футера - он только на главной */}
        
        <p className="text-xs text-gray-500">
          © {year} {USE_NEW_FEATURES ? "GetLifeUndo" : "LifeUndo"}. Все права защищены ·{" "}
