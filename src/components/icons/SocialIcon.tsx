type Props = { name: 'telegram'|'reddit'|'vc'|'habr'|'x'|'youtube'|'github'; className?: string };
export const SocialIcon = ({ name, className }: Props) => {
  ...
  switch (name) {
    ...
    case 'vc':       return (<svg className={cn} viewBox="0 0 24 24"><path fill="currentColor" d="M3 4h4l3 7 3-7h4L12 21"/></svg>);
