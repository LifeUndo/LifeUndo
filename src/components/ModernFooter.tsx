    ...
    <footer className="px-6 py-10 border-t border-white/10">
      ...
      <div className="max-w-6xl mx-auto mb-8">
        ...
        <div className="flex items-center gap-3" aria-label={t("footer.follow")}>
          ...
          {/* VK */}
          <a className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/5 hover:bg-white/10 transition" href="https://vk.com/getlifeundo" target="_blank" rel="noopener noreferrer" aria-label="VK">
