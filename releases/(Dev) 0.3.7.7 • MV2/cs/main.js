/* LifeUndo 0.3.7.7 — content script */
const FORBIDDEN = /^(about:|moz-extension:|chrome:|view-source:|file:\/)/i;
if (!FORBIDDEN.test(location.href)) {
  ...
  // Bootstrap: сразу + несколько попыток в первые секунды
  ...
  // Перед закрытием — последний снимок
